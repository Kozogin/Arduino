...
void sendSmsStatusBack(String telephone){
  try{
    ...
    SerialAT.println(textSmsStatusBack() + "\r\n" + (String)((char)26));
		...
		{
			std::cout << "TIGO::sendSmsStatusBack()    --------***********------------***********     " << "\n";
		}
}
