...
try{
  ...
  {
    std::cout << "WebContlol::saveCheckBox()    --------***********------------***********     " << "\n";
  }
}
...
void recordArray(char* array, char* m_array){
  ...
  {
    std::cout << "WebContlol::recordArray()    --------***********------------***********     " << "\n";
  }
} 
...
void readCheckBox(){
  ...
  {
    std::cout << "WebContlol::readCheckBox()    --------***********------------***********     " << "\n";
  }
}
...
void deleteItem(char* c, int size){
  ...
  {
    std::cout << "WebContlol::deleteItem(char* c, int size)    --------***********------------***********     " << "\n";
  }
}
...
void setCheck(state check, String &ownercheck){
  ...
  {
    std::cout << "WebContlol::setCheck(state check, String &ownercheck)    --------***********------------***********     " << "\n";
  }
}
...
void getOwnerTelephones(std::string* array){
  ...
  {
    std::cout << "WebContlol::getOwnerTelephones(std::string* array)    --------***********------------***********     " << "\n";
  } 
}
...
void getChecks(bool* array){
  ...
  {
    std::cout << "WebContlol::getChecks(bool* array)    --------***********------------***********     " << "\n";
  } 
}
...
bool getCheck(int index){
  ...
  {
    std::cout << "WebContlol::getCheck(int index)    --------***********------------***********     " << "\n";
  } 
  return false;
}

std::string getUssAc(){
  std::cout << " std::string getUssAc(){ -->" << ussAc << "<--" << "\n";
...
int getUss_sumAc(){
  ...
  {
    std::cout << "WebContlol::getUss_sumAc()    --------***********------------***********     " << "\n";
  } 
  return 5;
}
...
void getZonas(String* array){
  ...
  {
    std::cout << "WebContlol::getZonas(String* array)    --------***********------------***********     " << "\n";
  } 
}
